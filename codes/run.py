...
def objective():
    ...
    # args.gamma = 6.0
    # args.adversarial_temperature = 1.1

    # args.learning_rate = 0.003
    # args.batch_size = 1000
    # args.negative_sample_size = 200

    # # args.e_norm = trial.suggest_categorical('e_norm', [1.0, 1.5, 2.0])
    # args.e_norm = 0.588343112979635
    # args.r_norm = 0.99

    # # args.s_weight = trial.suggest_categorical('s_weight', [0.5, 1.0, 1.5, 2.0])
    # # args.h_weight = trial.suggest_categorical('h_weight', [4.0, 5.0, 6,0, 7.0])
    # args.s_weight = 0.5
    # args.h_weight = 5.0
    
    # args.regularization = 0.181582756029996
    
    # args.model = 'GeniE'
    # args.data_path = 'data/wn18rr'
    # args.max_steps = 60000
    # args.warm_up_steps = 20000
    ...
    args.house_dim = args.p_num + args.q_num
    args.house_num = args.house_dim
    # args.house_num = args.house_dim - args.hyb_split
